...
from core.forms import AlterarSenhaForm, CadastroPacienteForm, EncaixeForm, IdentificacaoForm, LoginPacienteForm, MeuPerfilForm, PacientePerfilForm, UsuarioSistemaForm
